        ...
        <div className="container-main">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-12 border-t" style={{ borderColor: 'var(--card-border)' }}>
               <div>
                  <h3 className="text-lg font-semibold mb-4" style={{ color: 'var(--text-primary)' }}>{t.transparency}</h3>
                  <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>{t.transparency_desc}</p>
               </div>
               <div>
                  <h3 className="text-lg font-semibold mb-4" style={{ color: 'var(--text-primary)' }}>{t.community}</h3>
                  <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>{t.community_desc}</p>
               </div>
            </div>
          </div>
        </div>
